...
function AddTodo() {
  ...
  return (
    <form onSubmit={addTodoHandler} className="space-x-3 mt-12 w-full flex gap-3">
      <input
        type="text"
      ...
      <button
        type="submit"
        className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg text-nowrap"
      >
        Add Todo
      </button>
    </form>
